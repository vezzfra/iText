...
class Text2_1: UIViewController, WCSessionDelegate, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        add.hidden = true
            ...
            if (NSUserDefaults.standardUserDefaults().objectForKey("Test2_Text") == nil) {
                
                cheatText.text = "Write here the text which you would see on the Apple Watch!"
                
            } else {
                
                let string2 = NSUserDefaults.standardUserDefaults().objectForKey("Test2_Text") as! String
    ...
    @IBAction func back(sender: UIButton) {
        ...
        NSUserDefaults.standardUserDefaults().setObject(cheatText.text, forKey: "Test2_Text")
    ...
    @IBAction func update(sender: UIButton) {
            ...
            NSUserDefaults.standardUserDefaults().setObject(cheatText.text, forKey: "Test2_Text")
            session.sendMessage(["m1": cheatText.text], replyHandler: nil, errorHandler: nil)
    ...
    func session(session: WCSession, didReceiveMessage message: [String : AnyObject], replyHandler: [String : AnyObject] -> Void) {
        ...
        dispatch_async(dispatch_get_main_queue()) {
            self.cheatText.text = message["m8"] as! String
        }
    }
    /*
    // MARK: - Navigation
