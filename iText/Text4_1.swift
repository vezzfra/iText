...
class Text4_1: UIViewController, WCSessionDelegate, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if (NSUserDefaults.standardUserDefaults().objectForKey("Test4_Text") == nil) {
            
            cheatText.text = "Write here the text which you would see on the Apple Watch!"
            
        } else {
            
            let string2 = NSUserDefaults.standardUserDefaults().objectForKey("Test4_Text") as! String
    ...
    @IBAction func back(sender: UIButton) {
        ...
        NSUserDefaults.standardUserDefaults().setObject(cheatText.text, forKey: "Test4_Text")
    ...
    @IBAction func update(sender: UIButton) {
        ...
        NSUserDefaults.standardUserDefaults().setObject(cheatText.text, forKey: "Test4_Text")
        session.sendMessage(["m3": cheatText.text], replyHandler: nil, errorHandler: nil)
    ...
    func session(session: WCSession, didReceiveMessage message: [String : AnyObject], replyHandler: [String : AnyObject] -> Void) {
        ...
        dispatch_async(dispatch_get_main_queue()) {
            self.cheatText.text = message["m6"] as! String
        }
    }
